...
@section('content')
    <section class="l-content-block p-team">
        <div class="container pb-100px">
            <p>
                •INITは、当社から送付したレッスンフィーなどについて、 <a href="{{ route('adviser-terms') }}#terms14" target="_blank" class="primary-link">講師規約14条④</a> に記載したとおり、税金や税金支払の手続きを全てを講師自身で対応していただくこととしております。<br>
                納税の義務やその体系は、日本をはじめ各国によって様々で、かつ複雑です。 ご不明な点は必ず各機関のホームページで調べたり、最寄りの税務署や各地方税理士会の相談窓口などでご相談ください。
            </p>
            <br>
            <p>
