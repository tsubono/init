...
return [
    ...
    "3 If it is found that another person's credit card was used for payment of coin purchase price" => "3 If it is found that another person's credit card was used for payment of coin purchase price",
    ...
    "A fact that flows out of the art and uses false or power to damage the opponent's credit or interferes the work of the other party" => "A fact that flows out of the art and uses false or power to damage the opponent's credit or interferes the work of the other party",
    ...
    "17-3. The student shall be able to download the call software in advance before performing a student registration and check if the call software is available in the subject's environment." => "17-3. The student shall be able to download the call software in advance before performing a student registration and check if the call software is available in the subject's environment.",
    "17-4. Our company allows students to take lessons due to the fact that the calling software could not be used in the student's environment, the hardware failure required to use the calling software, improper settings, and other reasons on the part of the student. If not, we will not take any responsibility." => "17-4. Our company allows students to take lessons due to the fact that the calling software could not be used in the student's environment, the hardware failure required to use the calling software, improper settings, and other reasons on the part of the student. If not, we will not take any responsibility.",
    ...
    "27-2. The Terms and Terms of the Company defined by the Company shall be effective in accordance with Article 3, paragraph 2, from the time when we notify the student's revised content." => "27-2. The Terms and Terms of the Company defined by the Company shall be effective in accordance with Article 3, paragraph 2, from the time when we notify the student's revised content.",
    ...
    "In-lecturer Fee's income and income declaration" => "In-lecturer Fee's income and income declaration",
    ...
    "Click here for Skype's download and registration method" => "Click here for Skype's download and registration method",
