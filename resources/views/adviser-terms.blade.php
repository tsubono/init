...
@section('title', 'アドバイザー規約')

@section('content')
    <section class="l-content-block p-team">
        <div class="container pb-100px">
            <p>
                株式会社　　　　　（以下、「当社」といいます。）が運営するサービスである「Init」（http://   以下、「本サービス」といいます。）は、以下の「講師規約」（以下、「本規約」といいます。）を承諾頂いた講師（後記第1条第1項第3号にて定義します。）にのみ提供させて頂くサービスです。講師は、あらかじめ本規約の内容に同意の上、本サービスを利用するものとします。
            </p>
            <br>
            <b>1. 定義・本サービスの内容</b>
            <p>
            ...
            <p>
                ...
                11-2. 講師は、レッスンの内容及び時間等に鑑み、当社が別途指定するポイント数の範囲でサービスフィーの支払に必要なポイント数（以下、「講師設定ポイント数」といいます。）を設定し、当社が別途指定する方法により当社サイト上に掲示するものとします。<br>
                11-3. レッスンフィーの金額は、講師設定ポイント数に相当する金額の60％、もしくは、別途「マージンレート」に定められた、60％以上の額（消費税相当額込みの金額）とします。なお、レッスンフィーを算出する場合に限り、1ポイントを常に1円（消費税相当額込みの金額）として計算するものとします。<br>
                11-4. 当社は、毎月３日を締め日として所定の方法で請求されたレッスンフィーにつき、当月の15日（15日が銀行の非営業日である場合には直後の営業日）までに、当月分のレッスンフィーを講師が別途指定し当社が事前に承認した銀行口座に振込送金の方法により送金するものとします。なお、当該振込に必要な手数料は当社が負担するものとし、当該銀行口座へのフィーの受領、および当該銀行口座から現金を引き出す際の手数料その他の手数料については講師が負担するものとします。<br>
                11-5. 支払請求の期限は、レッスン提供日付から6ヵ月とし、その日付を過ぎた場合には、講師はレッスンフィーの請求に関する全ての権利を失うものとします。<br>
                11-6. 前項の定めにかかわらず、当社は、以下の各号のいずれかに該当する場合、レッスンフィーの送金を留保することができるものとします。<br>
                ...
                11-7. 前項④の理由により、レッスンフィーの送金ができない場合、あるいは支払をしたにも関わらず口座情報の間違い・不足等によりレッスンフィーが当社に返却された場合、送金日から1ヶ月以内の再請求の場合に限り、再度送金手続きを行うものとする。なお、再度送金を行う場合には、当社指定の送金のための手数料を差し引いて送金を行うものとする。<br>
                11-8. 受講者規約及び当社が別途定める「キャンセルポリシー（受講者向け）」の定めに基づき当社が受講者からの使用ポイントの返還請求に応じた場合、受講者の講師に対するレッスンフィーの支払義務及び当社の講師に対する当該使用ポイントに対応するレッスンフィーの送金義務は消滅するものとし、当該レッスンフィーが送金済みの場合は、講師は直ちに当該送金済みのレッスンフィーに相当する金額を当社に返還するものとします。<br>
                11-9. レッスンフィーの算出は日本円で行い、支払いは講師が選択した支払い通貨に換算して行われるものとします。日本円と支払い通貨の換算レートは、本サービスの講師マイページ内に掲載するものとします。<br>
            </p>
            <br>
            <b>12. レッスン契約</b>
            <p>
