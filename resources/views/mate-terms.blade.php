    ...
    <section class="l-content-block p-team">
        <div class="container pb-100px">
            ...
            <p>
                ...
                {{ __('message.2-4. Lecturer's use of the service shall apply separately to the instructor terms that we establish separately.') }} <br>
            ...
            <p>
                ...
                {{ __('message.5-8. The Company does not take any responsibility even if the lecturer's or omissions of the lecturer or the third party suffered damage or losses.') }} <br>
            ...
            <p>
                ...
                &nbsp; {{ __('message.3 If it is found that another person's credit card was used for payment of coin purchase price') }} <br>
            ...
            <p>
                ...
                {{ __('message.17-3. The student shall be able to download the call software in advance before performing a student registration and check if the call software is available in the subject's environment.') }} <br>
                {{ __('message.17-4. Our company allows students to take lessons due to the fact that the calling software could not be used in the student's environment, the hardware failure required to use the calling software, improper settings, and other reasons on the part of the student. If not, we will not take any responsibility.') }} 
            </p>
            <br>
            ...
            <p>
                ...
                {{ __('message.27-2. The Terms and Terms of the Company defined by the Company shall be effective in accordance with Article 3, paragraph 2, from the time when we notify the student's revised content.') }} 
            </p>
            <br>
