<div class="row">
    ...
    <div class="col-12">
        ...
        <div class="row">
            <div class="col">
                <file-upload url="{{ isset($lesson->images[0]) ? $lesson->images[0]['image_path'] : null }}"></file-upload>
            </div>
            <div class="col">
                <file-upload url="{{ isset($lesson->images[1]) ? $lesson->images[1]['image_path'] : null }}"></file-upload>
            </div>
            <div class="col">
                <file-upload url="{{ isset($lesson->images[2]) ? $lesson->images[2]['image_path'] : null }}"></file-upload>
            </div>
        </div>
    </div>
