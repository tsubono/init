    ...
    <section class="l-content-block p-setting">
        <div class="container">
            ...
            <ul class="nav nav-pills p-setting__tab nav-fill" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button id="learn-tab" class="nav-link" data-bs-toggle="tab" data-bs-target="#learn" type="button" role="tab" aria-controls="learn" aria-selected="false">学びたい設定</button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button id="notification-tab" class="nav-link" data-bs-toggle="tab" data-bs-target="#notification" type="button" role="tab" aria-controls="notification" aria-selected="false">通知設定</button>
                </li>
            </ul>
            ...
            <div class="tab-content p-setting__content">
                ...
                <div id="learn" class="tab-pane" role="tabpanel" aria-labelledby="learn-tab">
                    ...
                    <form class="p-form" action="">
                        <div class="row">
                            <div class="col-12">
                                <h3 class="p-heading2">言語レベル<span class="badge bg-danger ms-2">必須</span></h3>
                                <!-- 切り替えボタンの設定 -->
                                ...
                                <div class="modal p-modal fade" id="form-categorymodal" tabindex="-1" aria-labelledby="form-categorymodalLabel">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="閉じる"></button>
                                            <div class="modal-body">
                                                <h2 class="p-heading2 mt-0">学びたいカテゴリ</h2>
                                                <div class="row">
                ...
                <div id="notification" class="tab-pane" role="tabpanel" aria-labelledby="notification-tab">
                    ...
                    <form class="p-form" action="">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="form-radio__notification" id="form-radio__notification-on" checked>
                            ...
                            <div class="col-6">
                                <div class="form-check">
                                    <input type="radio" class="form-check-input" name="form-radio__notification" id="form-radio__notification-off">
