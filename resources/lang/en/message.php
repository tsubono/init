...
return [
    ...
    "The transfer application has been completed" => "The transfer request has been completed",
    ...
    "Online with advisers around the world" => "Online with advisers around the world",
    ...
    "Have fun with your adviser." => "Have fun with your adviser.",
    "fashion" => "fashion",
    "Lifestyle" => "Lifestyle",
    "Beauty" => "Beauty",
    "Fitness" => "Fitness",
    ...
    "Adviser / Lesson" => "Adviser / Lesson",
    "Look for advisers and lessons. Lets look for what you want to do or Language to learn" => "Look for advisers and lessons. Lets look for what you want to do or Language to learn",
    "You can also look for from the origin of the adviser and the popularity." => "You can also look for from the origin of the adviser and the popularity.",
    "Reserve a lesson" => "Reserve a lesson",
    "If you find advisers and lessons you like, Check the schedule" => "If you find advisers and lessons you like, Check the schedule",
    "After the lesson date, we will start" => "After the lesson date, we will start",
    "When your teacher confirms your lesson request, you will receive a contract email. This completes the lesson reservation. Before the lesson, the adviser will send you a request to add Skype contact information, so please approve it." => "When your teacher confirms your lesson request, you will receive a contract email. This completes the lesson reservation. Before the lesson, the adviser will send you a request to add Skype contact information, so please approve it.",
    "Transfer application list" => "Transfer request list",
    ...
    "Transfer application status of" => "Transfer request status of",
    ...
    "Back to the list of attendances" => "Back to the list of attendances",
    "List of attendances" => "List of attendances",
    "List of students" => "List of mates",
    "search" => "search",
    "username" => "Username",
    "reset" => "reset",
    "export" => "export",
    ...
    "Purchase / date and time" => "Purchase / Use datetime",
    "Expiration date" => "Expiration date",
    "Number of sheets" => "Amount",
    ...
    "Adviser Back to list" => "Adviser Back to list",
    "Adviser list" => "Adviser list",
    "Adviser was not found." => "Adviser was not found.",
    ...
    "Adviser registration" => "Adviser registration",
    "name" => "Name",
    "Surname" => "family name",
    ...
    "Profile Update Screen" => "Profile Update",
    ...
    "Transfer application confirmation" => "Transfer request confirmation",
    ...
    "Adviser: A person who wants or actually provides a lesson" => "Adviser: A person who wants or actually provides a lesson",
    "Lesson contract: A contract regarding the provision and attendance of lessons concluded between the adviser and the student." => "Lesson contract: A contract regarding the provision and attendance of lessons concluded between the adviser and the student.",
    "Lesson fee: Fee paid by the student to the adviser through our company in consideration of the lesson contract" => "Lesson fee: Fee paid by the student to the adviser through our company in consideration of the lesson contract",
    ...
    "A service that facilitates the advisers acceptance of lesson contract applications from students" => "A service that facilitates the advisers acceptance of lesson contract applications from students",
    ...
    "This agreement shall apply to the use of this service by the adviser." => "This agreement shall apply to the use of this service by the adviser.",
    "In addition to these Terms, all notices issued by the Company to the adviser based on Article 3, including the Terms of Use and the provisions established by the Company and postings on the Companys website (hereinafter collectively referred to as Terms of Use, etc. Established by the Company, etc. ) Each constitutes a part of this agreement." => "In addition to these Terms, all notices issued by the Company to the adviser based on Article 3, including the Terms of Use and the provisions established by the Company and postings on the Companys website (hereinafter collectively referred to as Terms of Use, etc. Established by the Company, etc. ) Each constitutes a part of this agreement.",
    ...
    "The Company shall notify the adviser of matters that the Company deems necessary at any time by posting on the Companys site, sending e-mails, sending documents, or any other method that the Company deems appropriate." => "The Company shall notify the adviser of matters that the Company deems necessary at any time by posting on the Companys site, sending e-mails, sending documents, or any other method that the Company deems appropriate.",
    ...
    "In order for the adviser to use this service, it is necessary to meet all of the following conditions." => "In order for the adviser to use this service, it is necessary to meet all of the following conditions.",
    ...
    "The adviser shall judge the truth, accuracy, certainty, reliability, usefulness, etc. of the information provided by the Company and other quality, accuracy, certainty, reliability, usefulness, etc. of this service by himself / herself. , You agree in advance to use these at your own risk." => "The adviser shall judge the truth, accuracy, certainty, reliability, usefulness, etc. of the information provided by the Company and other quality, accuracy, certainty, reliability, usefulness, etc. of this service by himself / herself. , You agree in advance to use these at your own risk.",
    "We do not hire advisers, and advisers agree in advance that no employment contract will be established between us and the adviser." => "We do not hire advisers, and advisers agree in advance that no employment contract will be established between us and the adviser.",
    "We will do our utmost to ensure the safety of this site so that our advisers can provide lessons with peace of mind, but we do not guarantee it." => "We will do our utmost to ensure the safety of this site so that our advisers can provide lessons with peace of mind, but we do not guarantee it.",
    "When using this service, the adviser will always give top priority to the students and will try to do their best to the extent that they can think with good sense." => "When using this service, the adviser will always give top priority to the students and will try to do their best to the extent that they can think with good sense.",
    "We will do our utmost to ensure that our students are given lessons smoothly and satisfactorily. Therefore, if we determine that the quality of the lessons provided by the adviser, the prior communication accompanying the implementation, and the quality of customer service do not reach the level required by item 4 of this article, we will contact the adviser at our discretion. The service fee can be returned with the cancellation of the lesson fee without prior notice. In addition, if the advisers attitude toward customer service / response and customer service are significantly different from the standards required by the Company, the registration of the adviser may be canceled at the discretion of the Company." => "We will do our utmost to ensure that our students are given lessons smoothly and satisfactorily. Therefore, if we determine that the quality of the lessons provided by the adviser, the prior communication accompanying the implementation, and the quality of customer service do not reach the level required by item 4 of this article, we will contact the adviser at our discretion. The service fee can be returned with the cancellation of the lesson fee without prior notice. In addition, if the advisers attitude toward customer service / response and customer service are significantly different from the standards required by the Company, the registration of the adviser may be canceled at the discretion of the Company.",
    "In principle, lessons will be provided by the adviser, and we will not provide lessons unless we deem it necessary." => "In principle, lessons will be provided by the adviser, and we will not provide lessons unless we deem it necessary.",
    "We undertake no obligation to assess or manage the lessons provided by the adviser and the information provided to each other between the adviser and the student." => "We undertake no obligation to assess or manage the lessons provided by the adviser and the information provided to each other between the adviser and the student.",
    "The Company does not guarantee the truthfulness, certainty, reliability, usefulness, etc. of the identity information of the adviser and students and other information posted by the adviser and students." => "The Company does not guarantee the truthfulness, certainty, reliability, usefulness, etc. of the identity information of the adviser and students and other information posted by the adviser and students.",
    "The Company shall not be liable for any act that the adviser violates the law in connection with this service." => "The Company shall not be liable for any act that the adviser violates the law in connection with this service.",
    ...
    "The adviser shall not provide information, files, goods, etc. to the students for any purpose other than fulfilling the lesson contract concluded by the matching service, unless otherwise approved by the Company." => "The adviser shall not provide information, files, goods, etc. to the students for any purpose other than fulfilling the lesson contract concluded by the matching service, unless otherwise approved by the Company.",
    "Trouble with other teachers" => "Trouble with other teachers",
    "In the unlikely event that the adviser suffers some damage or inconvenience from other students, advisers or other third parties, and if a problem occurs between the adviser and other advisers, students or other third parties, We will try to resolve the problem at our own risk and expense, and if we suffer any damage in connection with the trouble, all the damage (including but not limited to reasonable attorneys fees). ) Shall be liable for immediate compensation. If the Company resolves the problem, the adviser will be responsible for all costs (including but not limited to reasonable attorneys fees) required to resolve the problem." => "In the unlikely event that the adviser suffers some damage or inconvenience from other students, advisers or other third parties, and if a problem occurs between the adviser and other advisers, students or other third parties, We will try to resolve the problem at our own risk and expense, and if we suffer any damage in connection with the trouble, all the damage (including but not limited to reasonable attorneys fees). ) Shall be liable for immediate compensation. If the Company resolves the problem, the adviser will be responsible for all costs (including but not limited to reasonable attorneys fees) required to resolve the problem.",
    "The adviser himself enters his name, gender, e-mail address, desired password, country of residence and other information specified separately by us in the input form on the adviser registration page on our site, and sends it to us. Adviser registration application (hereinafter referred to as adviser registration application) shall be made by a method specified separately by. The adviser shall not allow a third party to apply for adviser registration, and shall not enter false information when applying for adviser registration." => "The adviser himself enters his name, gender, e-mail address, desired password, country of residence and other information specified separately by us in the input form on the adviser registration page on our site, and sends it to us. Adviser registration application (hereinafter referred to as adviser registration application) shall be made by a method specified separately by. The adviser shall not allow a third party to apply for adviser registration, and shall not enter false information when applying for adviser registration.",
    "The Company shall approve the adviser registration application by sending an e-mail to the adviser to the effect that the adviser registration application is accepted or by any other method separately determined by the Company." => "The Company shall approve the adviser registration application by sending an e-mail to the adviser to the effect that the adviser registration application is accepted or by any other method separately determined by the Company.",
    "If any of the following items apply, we may not accept the adviser registration application without disclosing the reason." => "If any of the following items apply, we may not accept the adviser registration application without disclosing the reason.",
    "When it is found that the adviser registration application was made by a third party other than the adviser (except when the Company approves separately)" => "When it is found that the adviser registration application was made by a third party other than the adviser (except when the Company approves separately)",
    "When it is found that the contents entered at the time of application for adviser registration are false, incorrect, or omitted." => "When it is found that the contents entered at the time of application for adviser registration are false, incorrect, or omitted.",
    "When it is found that the adviser has been deleted from the adviser registration due to a violation of this agreement in the past" => "When it is found that the adviser has been deleted from the adviser registration due to a violation of this agreement in the past",
    "In addition, if we accept the adviser registration application, or if we determine that it is inappropriate to accept the adviser registration application, if we determine that it is inappropriate to accept it." => "In addition, if we accept the adviser registration application, or if we determine that it is inappropriate to accept the adviser registration application, if we determine that it is inappropriate to accept it.",
    "If there is a change in the name, e-mail address, country of residence or other information specified by us when applying for adviser registration, the adviser shall immediately notify us by the method separately determined by us." => "If there is a change in the name, e-mail address, country of residence or other information specified by us when applying for adviser registration, the adviser shall immediately notify us by the method separately determined by us.",
    "The adviser may cancel the adviser registration by himself / herself according to the procedure separately determined by the Company. However, this does not apply if you already have a confirmed lesson schedule." => "The adviser may cancel the adviser registration by himself / herself according to the procedure separately determined by the Company. However, this does not apply if you already have a confirmed lesson schedule.",
    "Suspension of provision of this service ・ Cancellation of adviser registration by our company" => "Suspension of provision of this service ・ Cancellation of adviser registration by our company",
    "If the adviser falls under any of the following items, the Company may suspend the provision of this service to the adviser or cancel the adviser registration without prior notice." => "If the adviser falls under any of the following items, the Company may suspend the provision of this service to the adviser or cancel the adviser registration without prior notice.",
    "If it is found that the adviser registration has been deleted due to a violation of this agreement in the past" => "If it is found that the adviser registration has been deleted due to a violation of this agreement in the past",
    ...
    "In addition, if we determine that it is inappropriate to provide this service or maintain adviser registration." => "In addition, if we determine that it is inappropriate to provide this service or maintain adviser registration.",
    "Password management and use, etc." => "Password management and use, etc.",
    "The adviser shall be responsible for the management and use of the password issued by the Company to the adviser (hereinafter referred to as password), and the Company shall not be responsible for the management of the password." => "The adviser shall be responsible for the management and use of the password issued by the Company to the adviser (hereinafter referred to as password), and the Company shall not be responsible for the management of the password.",
    "The adviser shall not assign, lend, disclose, or use the password to a third party unless otherwise approved by the Company." => "The adviser shall not assign, lend, disclose, or use the password to a third party unless otherwise approved by the Company.",
    "The adviser who holds the password shall bear all responsibility for any disadvantage, damage, falsification, etc. due to mistakes in the use of the password or unauthorized use by a third party, and the Company shall not be liable at all. increase." => "The adviser who holds the password shall bear all responsibility for any disadvantage, damage, falsification, etc. due to mistakes in the use of the password or unauthorized use by a third party, and the Company shall not be liable at all. increase.",
    "If the adviser discovers that the password has been used illegally by a third party without permission, the adviser shall immediately contact the Company and shall comply with the instructions from the Company." => "If the adviser discovers that the password has been used illegally by a third party without permission, the adviser shall immediately contact the Company and shall comply with the instructions from the Company.",
    "Cost burden" => "Cost burden",
    "The adviser will use the hardware (including but not limited to PCs, headsets, microphones, earphones, etc.) and software (Article 18, Paragraph 1 below) necessary to use this service or provide lessons. Including, but not limited to, the calling software specified in Section), communication lines and everything else shall be prepared at your own risk and expense." => "The adviser will use the hardware (including but not limited to PCs, headsets, microphones, earphones, etc.) and software (Article 18, Paragraph 1 below) necessary to use this service or provide lessons. Including, but not limited to, the calling software specified in Section), communication lines and everything else shall be prepared at your own risk and expense.",
    "The adviser acknowledges that the use of this service or the provision of lessons will incur communication costs such as telephone charges, internet connection costs, electricity costs and other costs in addition to those specified in the preceding paragraph, and shall bear these costs. increase." => "The adviser acknowledges that the use of this service or the provision of lessons will incur communication costs such as telephone charges, internet connection costs, electricity costs and other costs in addition to those specified in the preceding paragraph, and shall bear these costs. increase.",
    "Lesson fee" => "Lesson fee",
    "The adviser shall grant us all the authority necessary for us to collect lesson fees from the students on behalf of the advisers or to return the lesson fees collected from the students." => "The adviser shall grant us all the authority necessary for us to collect lesson fees from the students on behalf of the advisers or to return the lesson fees collected from the students.",
    ...
    "The deadline for billing is 6 months from the date the lesson is offered, after which the adviser shall lose all rights to claim the lesson fee." => "The deadline for billing is 6 months from the date the lesson is offered, after which the adviser shall lose all rights to claim the lesson fee.",
    ...
    "If we determine that the adviser has violated or may have violated this agreement" => "If we determine that the adviser has violated or may have violated this agreement",
    "When the Company cannot pay the lesson fee due to an error or lack of information such as the bank account specified in Paragraph 4 of this Article or other information reported to the Company by the adviser." => "When the Company cannot pay the lesson fee due to an error or lack of information such as the bank account specified in Paragraph 4 of this Article or other information reported to the Company by the adviser.",
    ...
    "If we respond to a request from a student to return the points used based on the student agreement and the Cancellation Policy (for students) separately set by us, we will be obliged to pay the lesson fee to the adviser of the student and our company. The obligation to remit the lesson fee corresponding to the points used to the adviser shall be extinguished, and if the lesson fee has been remitted, the adviser shall immediately return the amount equivalent to the remitted lesson fee to the Company. .." => "If we respond to a request from a student to return the points used based on the student agreement and the Cancellation Policy (for students) separately set by us, we will be obliged to pay the lesson fee to the adviser of the student and our company. The obligation to remit the lesson fee corresponding to the points used to the adviser shall be extinguished, and if the lesson fee has been remitted, the adviser shall immediately return the amount equivalent to the remitted lesson fee to the Company. ..",
    "The lesson fee will be calculated in Japanese Yen and the payment will be converted into the payment currency selected by the adviser." => "The lesson fee will be calculated in Japanese Yen and the payment will be converted into the payment currency selected by the adviser.",
    ...
    "The lesson contract shall be established when the adviser sends an e-mail to the effect that the adviser accepts the application using the system on this service in response to the lesson contract application by the student." => "The lesson contract shall be established when the adviser sends an e-mail to the effect that the adviser accepts the application using the system on this service in response to the lesson contract application by the student.",
    "The adviser agrees in advance that the student can apply for the lesson contract or cancel the lesson contract after it is established based on the Cancellation Policy (for students) separately set by the Company." => "The adviser agrees in advance that the student can apply for the lesson contract or cancel the lesson contract after it is established based on the Cancellation Policy (for students) separately set by the Company.",
    "Regarding whether or not the adviser can refuse the lesson contract application received from the student, whether or not the lesson contract can be canceled or the time can be changed after the establishment, and the handling when the lesson contract after the establishment is canceled, etc. Policy (for advisers) ”." => "Regarding whether or not the adviser can refuse the lesson contract application received from the student, whether or not the lesson contract can be canceled or the time can be changed after the establishment, and the handling when the lesson contract after the establishment is canceled, etc. Policy (for advisers) ”.",
    "The Company shall be able to request the adviser to provide information that the Company deems necessary in the event of a situation that falls under or is expected to fall under any of the following items, and the adviser shall be concerned. You must respond to your request immediately." => "The Company shall be able to request the adviser to provide information that the Company deems necessary in the event of a situation that falls under or is expected to fall under any of the following items, and the adviser shall be concerned. You must respond to your request immediately.",
    "When the adviser or student cancels the lesson contract after it is established" => "When the adviser or student cancels the lesson contract after it is established",
    ...
    "The adviser shall not perform the following acts in connection with the use of this service or the provision of lessons." => "The adviser shall not perform the following acts in connection with the use of this service or the provision of lessons.",
    ...
    "Acts that infringe or may infringe other advisers, students or other third parties or our property, privacy, portrait rights or publicity rights" => "Acts that infringe or may infringe other advisers, students or other third parties or our property, privacy, portrait rights or publicity rights",
    ...
    "Acts that infringe or may infringe intellectual property rights such as copyrights and trademark rights of other advisers, students and other third parties or our company" => "Acts that infringe or may infringe intellectual property rights such as copyrights and trademark rights of other advisers, students and other third parties or our company",
    "Acts that discriminate against or slander other advisers, students or other third parties or the Company, or damage the honor or credibility of other advisers, students or other third parties or the Company" => "Acts that discriminate against or slander other advisers, students or other third parties or the Company, or damage the honor or credibility of other advisers, students or other third parties or the Company",
    ...
    "Acts of using this service by pretending to be another adviser, student, or other third party" => "Acts of using this service by pretending to be another adviser, student, or other third party",
    ...
    "Acts of introducing or arranging services that conflict with or may conflict with this service to other advisers, students, and other third parties." => "Acts of introducing or arranging services that conflict with or may conflict with this service to other advisers, students, and other third parties.",
    "The act of providing information about this service that you have learned as an adviser to a third party who competes with or may conflict with this service." => "The act of providing information about this service that you have learned as an adviser to a third party who competes with or may conflict with this service.",
    ...
    "The adviser may use the information about the students that he / she has learned in connection with this service for purposes other than the use of this service and the fulfillment of the lesson contract concluded by the matching service, not only during the adviser registration but also after the adviser registration is deleted. It shall not be used, and no direct lesson application, etc. shall be made to the students included in the information without using the matching service." => "The adviser may use the information about the students that he / she has learned in connection with this service for purposes other than the use of this service and the fulfillment of the lesson contract concluded by the matching service, not only during the adviser registration but also after the adviser registration is deleted. It shall not be used, and no direct lesson application, etc. shall be made to the students included in the information without using the matching service.",
    "Adviser responsibility" => "Adviser responsibility",
    "The adviser expresses and warrants to the Company the matters specified in the following items, and agrees in advance that the Company will not be liable for any violation of the items specified in the following items. will do." => "The adviser expresses and warrants to the Company the matters specified in the following items, and agrees in advance that the Company will not be liable for any violation of the items specified in the following items. will do.",
    "The information uploaded by the adviser on this site and other information reported to us by the adviser must be accurate and up-to-date." => "The information uploaded by the adviser on this site and other information reported to us by the adviser must be accurate and up-to-date.",
    "Information provided by the adviser to the students and the truth, accuracy, reliability, usefulness, etc. of the lesson" => "Information provided by the adviser to the students and the truth, accuracy, reliability, usefulness, etc. of the lesson",
    ...
    "Regarding the lesson fee received from our company, we will take full responsibility for the tax and tax payment procedures, etc. in accordance with the laws and regulations of the advisers country of origin and country of residence." => "Regarding the lesson fee received from our company, we will take full responsibility for the tax and tax payment procedures, etc. in accordance with the laws and regulations of the advisers country of origin and country of residence.",
    "E-mail, uploaded information, etc." => "E-mail, uploaded information, etc.",
    "The Company shall not be liable for the contents of e-mails or uploaded information created by advisers, students and other third parties." => "The Company shall not be liable for the contents of e-mails or uploaded information created by advisers, students and other third parties.",
    "The adviser shall be solely responsible for the advisers e-mail transmission, uploading of information, correspondence with the e-mail service provider, and other conditions, guarantees or representations related to the correspondence, and the adviser shall take such correspondence. You agree to indemnify us from any kind of damage or loss as a result of." => "The adviser shall be solely responsible for the advisers e-mail transmission, uploading of information, correspondence with the e-mail service provider, and other conditions, guarantees or representations related to the correspondence, and the adviser shall take such correspondence. You agree to indemnify us from any kind of damage or loss as a result of.",
    "Handling of confidential information, etc." => "Handling of confidential information, etc.",
    "The adviser will use the personal information of the adviser and other information about the adviser (hereinafter referred to as personal information, etc. .) Will be provided to us. Of the personal information, etc., the information that we have obtained prior consent from the adviser to post on this site after clearly stating that we will post it on this site for the purpose of notifying the students separately in the input form etc. It shall be posted on the site." => "The adviser will use the personal information of the adviser and other information about the adviser (hereinafter referred to as personal information, etc. .) Will be provided to us. Of the personal information, etc., the information that we have obtained prior consent from the adviser to post on this site after clearly stating that we will post it on this site for the purpose of notifying the students separately in the input form etc. It shall be posted on the site.",
    "In addition to what is specifically stipulated in this agreement, the adviser may be another adviser, student or other third party obtained in connection with the use of this service or the provision of lessons, not only during the adviser registration but also after the adviser registration has been deleted. And all information about our company (hereinafter referred to as confidential information) shall be kept strictly confidential, and may be disclosed or leaked to a third party regardless of the method. It shall not be used for any purpose other than the use of this service and the fulfillment of the lesson contract concluded by the matching service." => "In addition to what is specifically stipulated in this agreement, the adviser may be another adviser, student or other third party obtained in connection with the use of this service or the provision of lessons, not only during the adviser registration but also after the adviser registration has been deleted. And all information about our company (hereinafter referred to as confidential information) shall be kept strictly confidential, and may be disclosed or leaked to a third party regardless of the method. It shall not be used for any purpose other than the use of this service and the fulfillment of the lesson contract concluded by the matching service.",
    "The adviser shall immediately return or dispose of any information, files, goods, etc. received from the Company in accordance with the instructions of the Company if requested by the Company or if the adviser registration is deleted." => "The adviser shall immediately return or dispose of any information, files, goods, etc. received from the Company in accordance with the instructions of the Company if requested by the Company or if the adviser registration is deleted.",
    "The adviser shall not use this service to provide information about the content of the lesson to other advisers. However, this does not apply to the information posted on this site based on Paragraph 1 of this Article." => "The adviser shall not use this service to provide information about the content of the lesson to other advisers. However, this does not apply to the information posted on this site based on Paragraph 1 of this Article.",
    "In addition to what is specifically provided for in these Terms, the adviser must not provide information about lesson fees and services that conflict with or may conflict with this service to other advisers, students or other third parties. will do." => "In addition to what is specifically provided for in these Terms, the adviser must not provide information about lesson fees and services that conflict with or may conflict with this service to other advisers, students or other third parties. will do.",
    "Grant of license right" => "Grant of license right",
    "The adviser will use and disclose to the Company the information that the adviser has uploaded to the profile page and other web pages of our site (including but not limited to information generated or derived from this information) worldwide. , Display, reproduction, modification, translation, distribution, deletion, etc. Non-exclusive license rights with sublicense rights shall be granted free of charge and permanently. In addition, all information other than personal information uploaded by the adviser to the profile page and other web pages of our site, including texts, photos, paintings, music, and evaluations, includes information for which we receive license rights from the adviser based on the main text of this article. Information is assumed to be included." => "The adviser will use and disclose to the Company the information that the adviser has uploaded to the profile page and other web pages of our site (including but not limited to information generated or derived from this information) worldwide. , Display, reproduction, modification, translation, distribution, deletion, etc. Non-exclusive license rights with sublicense rights shall be granted free of charge and permanently. In addition, all information other than personal information uploaded by the adviser to the profile page and other web pages of our site, including texts, photos, paintings, music, and evaluations, includes information for which we receive license rights from the adviser based on the main text of this article. Information is assumed to be included.",
    "Use of calling software" => "Use of calling software",
    "When providing lessons, the adviser shall use the online calling software designated by us (hereinafter referred to as calling software) provided by a third party." => "When providing lessons, the adviser shall use the online calling software designated by us (hereinafter referred to as calling software) provided by a third party.",
    "When using the calling software, the adviser shall comply with the terms of use, terms of use and other provisions set by the third party who provides the calling software." => "When using the calling software, the adviser shall comply with the terms of use, terms of use and other provisions set by the third party who provides the calling software.",
    "Before registering as an adviser, the adviser must download the calling software and check whether the calling software can be used in the advisers environment." => "Before registering as an adviser, the adviser must download the calling software and check whether the calling software can be used in the advisers environment.",
    ...
    "The Company shall not be liable for any damage or loss incurred by the adviser due to the act or omission of a third party including other advisers." => "The Company shall not be liable for any damage or loss incurred by the adviser due to the act or omission of a third party including other advisers.",
    "In addition to the provisions of this agreement, the Company shall not be liable for any damage or loss incurred by the adviser in connection with the use of this service." => "In addition to the provisions of this agreement, the Company shall not be liable for any damage or loss incurred by the adviser in connection with the use of this service.",
    "The Company shall not be liable for any damage or loss caused by the adviser to other advisers, students or other third parties in connection with the use of this service." => "The Company shall not be liable for any damage or loss caused by the adviser to other advisers, students or other third parties in connection with the use of this service.",
    "Relationship with advertisers, etc." => "Relationship with advertisers, etc.",
    "When the adviser participates in the sales promotion activities of the advertisers and other businesses (hereinafter referred to as advertisers, etc.) of the advertisements posted on this site, troubles that occur between the adviser and the advertisers, etc. It is agreed that all such matters should be processed and resolved between the adviser and the advertiser." => "When the adviser participates in the sales promotion activities of the advertisers and other businesses (hereinafter referred to as advertisers, etc.) of the advertisements posted on this site, troubles that occur between the adviser and the advertisers, etc. It is agreed that all such matters should be processed and resolved between the adviser and the advertiser.",
    ...
    "The adviser agrees in advance to indemnify the Company for any damage or loss caused to the adviser by the advertiser or other third party." => "The adviser agrees in advance to indemnify the Company for any damage or loss caused to the adviser by the advertiser or other third party.",
    "Suspension of provision of this service" => "Suspension of provision of this service",
    "The Company shall be able to temporarily suspend the provision of this service without notifying the adviser in advance in any of the following cases." => "The Company shall be able to temporarily suspend the provision of this service without notifying the adviser in advance in any of the following cases.",
    ...
    "The Company shall be able to change or add the contents of this service without notifying the adviser in advance." => "The Company shall be able to change or add the contents of this service without notifying the adviser in advance.",
    "Abolition of this service" => "Abolition of this service",
    "The Company shall be able to abolish this service by notifying the adviser." => "The Company shall be able to abolish this service by notifying the adviser.",
    ...
    "The Company shall be able to revise this agreement, the terms of use, etc. established by the Company without obtaining the consent of the adviser." => "The Company shall be able to revise this agreement, the terms of use, etc. established by the Company without obtaining the consent of the adviser.",
    "The revised Terms and Conditions, Terms of Use, etc. established by the Company shall become effective in accordance with Article 3, Paragraph 2 from the time the Company notifies the adviser of the revised content." => "The revised Terms and Conditions, Terms of Use, etc. established by the Company shall become effective in accordance with Article 3, Paragraph 2 from the time the Company notifies the adviser of the revised content.",
    "Compensation for damages" => "Compensation for damages",
    "In addition to what is specifically stipulated in this agreement, if the adviser causes damage to the Company by violating this agreement, or intentionally or negligently, all damages (including reasonable attorneys fees) to the Company. (Not limited to this)) shall be liable for immediate compensation." => "In addition to what is specifically stipulated in this agreement, if the adviser causes damage to the Company by violating this agreement, or intentionally or negligently, all damages (including reasonable attorneys fees) to the Company. (Not limited to this)) shall be liable for immediate compensation.",
    ...
    "The adviser shall not assign or inherit all or part of the rights and obligations based on this agreement to a third party, or provide it as collateral." => "The adviser shall not assign or inherit all or part of the rights and obligations based on this agreement to a third party, or provide it as collateral.",
    "Elimination of antisocial forces" => "Elimination of antisocial forces",
    "The adviser expresses that it does not fall under any one of the following items, and expresses that it does not fall under any of the following items, and warrants it." => "The adviser expresses that it does not fall under any one of the following items, and expresses that it does not fall under any of the following items, and warrants it.",
    ...
    "If there is a need for a proceeding between the adviser and the Company or between the student and the adviser in connection with this service, the adviser in the court of jurisdiction and the Company shall file a proceeding with the Tokyo District Court or the Tokyo Summary Court according to the amount of the proceeding. You agree to be the exclusive agreement jurisdictional court of the first instance." => "If there is a need for a proceeding between the adviser and the Company or between the student and the adviser in connection with this service, the adviser in the court of jurisdiction and the Company shall file a proceeding with the Tokyo District Court or the Tokyo Summary Court according to the amount of the proceeding. You agree to be the exclusive agreement jurisdictional court of the first instance.",
    ...
    "Even after the adviser registration is deleted, Article 2, Article 3, Article 5, Paragraphs 1 to 3, Article 5, Paragraphs 5 to 8, Article 6, Article 9, Article 10, Article 10 Article 11 Paragraph 2, Article 11 Paragraphs 5 to 7, Article 12, Article 14 to Article 17, Article 18 Paragraph 4, Article 19, Article 20, Article 24, Article 26 Or each provision of this article shall still be valid." => "Even after the adviser registration is deleted, Article 2, Article 3, Article 5, Paragraphs 1 to 3, Article 5, Paragraphs 5 to 8, Article 6, Article 9, Article 10, Article 10 Article 11 Paragraph 2, Article 11 Paragraphs 5 to 7, Article 12, Article 14 to Article 17, Article 18 Paragraph 4, Article 19, Article 20, Article 24, Article 26 Or each provision of this article shall still be valid.",
    "Talk resolution" => "Talk resolution",
    "Matters not stipulated in this agreement or matters that raise doubts about the interpretation of this agreement shall be resolved after discussions in good faith between the adviser and the Company." => "Matters not stipulated in this agreement or matters that raise doubts about the interpretation of this agreement shall be resolved after discussions in good faith between the adviser and the Company.",
    ...
    "Search for advisers" => "Search for advisers",
    ...
    "Cancel Cancel Cancel" => "Request Cancel ",
    "Request" => "Request",
    "Taking" => "Taking",
    "Denial" => "Denial",
    "Subject" => "Subject",
    ...
    "Approve the application from username" => "Approve the application from :username",
    "Denial confirmation" => "Denial confirmation",
    "Denial an request from username" => "Representing an application from :username",
    "Request Cancel Confirmation" => "Request Cancel Confirmation",
    ...
    "Confirmation of completion of attendance" => "Confirmation of completion of attendance",
    "Complete the attendance for username" => "Complete the attendance for :username",
    "Cancel confirmation" => "Cancel confirmation for :username",
    "Cancel the attendance for username" => "Cancel the attendance for :username",
    "Report confirmation" => "Report confirmation",
    "Report of lesson" => "Report of :lesson",
    ...
    "Score" => "Score",
    "Taking details" => "Attendance details",
    ...
    "· Report to adviser" => "· Report to adviser",
    "If the adviser does not appear after a certain amount of time has passed since the start time of the lesson on the day, the student will be given the right to use the report button. If the adviser is notified, the adviser will refund the full tuition fee to the student, and the evaluation may be lowered by the review from the student." => "If the adviser does not appear after a certain amount of time has passed since the start time of the lesson on the day, the student will be given the right to use the report button. If the adviser is notified, the adviser will refund the full tuition fee to the student, and the evaluation may be lowered by the review from the student.",
    "· Report to the student" => "· Report to the student",
    "If the student does not appear after a certain amount of time has passed since the start time of the lesson on the day, the adviser will be given the right to use the report button. If there is a report to the student, the secretariat shall collect 50% of the tuition fee from the student as the adviser and the remaining 50% as the operation and maintenance fee." => "If the student does not appear after a certain amount of time has passed since the start time of the lesson on the day, the adviser will be given the right to use the report button. If there is a report to the student, the secretariat shall collect 50% of the tuition fee from the student as the adviser and the remaining 50% as the operation and maintenance fee.",
    ...
    "To List" => "To List",
    "notice" => "notice",
    "Mate login" => "Mate login",
    "Adviser login" => "Adviser login",
    "Navigation switching" => "Navigation switching",
    "home" => "home",
    "For the first time" => "For the first time",
    "Lesson search" => "Lesson search",
    "Adviser search" => "Adviser search",
    "Logout" => "Logout",
    "Login" => "Login",
    "profile" => "profile",
    "Coin management" => "Coin management",
    "sales management" => "Sales management",
    "Adviser management" => "Adviser management",
    "Student management" => "Mate management",
    "Taking management" => "Attendance management",
    "Transfer application management" => "Transfer request management",
    ...
    "What you want to do in Language you want to learn. Register with INIT and find your own teacher from all over the world. Why dont you challenge your goals by learning happily with advisers who connect with you through your hobbies instead of just studying? INIT is waiting for your challenge!" => "What you want to do in Language you want to learn. Register with INIT and find your own teacher from all over the world. Why dont you challenge your goals by learning happily with advisers who connect with you through your hobbies instead of just studying? INIT is waiting for your challenge!",
    "About Team INIT" => "About Team INIT",
    "Display based on special business" => "Display based on special business",
    "cancellation policy" => "Cancellation policy",
    "Terms of study" => "Terms of mate",
    "Terms of adviser" => "Terms of adviser",
    ...
    "※ The advisers lessonable time is a summer time deployment country and an uninfected country, and the display may be shifted by one hour." => "※ The advisers lessonable time is a summer time deployment country and an uninfected country, and the display may be shifted by one hour.",
    ...
    "If you have contact from the adviser, you can set or set an email notification" => "If you have contact from the adviser, you can set or set an email notification",
    "Receive" => "Receive",
    ...
    "It is a month" => "months from the date of purchase",
    ...
    "3 Adviser: Person who wants to provide lessons or actually offers" => "3 Adviser: Person who wants to provide lessons or actually offers",
    "4 Lesson Agreement: Contract for the provision of lessons concluded between the adviser and the student" => "4 Lesson Agreement: Contract for the provision of lessons concluded between the adviser and the student",
    "5 Lesson Fee: A fee that the student pays to the adviser through our company as a compensation for the lesson contract" => "5 Lesson Fee: A fee that the student pays to the adviser through our company as a compensation for the lesson contract",
    ...
    "⑤ A service that regularly or irregularly distributes updated information on our site, campaign information, and other information separately determined by our company to students by e-mail (hereinafter referred to as email magazine service)." => "⑤ A service that regularly or irregularly distributes updated information on our site, campaign information, and other information separately determined by our company to students by e-mail (hereinafter referred to as email magazine service).",
    "6 Services to facilitate the acceptance of lesson contract from students by adviser" => "6 Services to facilitate the acceptance of lesson contract from students by adviser",
    ...
    "2-4. Advisers use of the service shall apply separately to the adviser terms that we establish separately." => "2-4. Advisers use of the service shall apply separately to the adviser terms that we establish separately.",
    ...
    "5-2. Students shall determine their own quality, accuracy, reliability, usefulness, etc. of the lessons provided by the adviser, and we will agree in advance to use them at their own responsibility ." => "5-2. Students shall determine their own quality, accuracy, reliability, usefulness, etc. of the lessons provided by the adviser, and we will agree in advance to use them at their own responsibility .",
    "5-3. Before applying for a lesson contract, students should thoroughly check the information about the adviser who provides the lesson before applying for the lesson contract, and question the identity of the adviser and the content of the lesson to be provided. If there is, we will contact the adviser directly using the mail function to the adviser on this service." => "5-3. Before applying for a lesson contract, students should thoroughly check the information about the adviser who provides the lesson before applying for the lesson contract, and question the identity of the adviser and the content of the lesson to be provided. If there is, we will contact the adviser directly using the mail function to the adviser on this service.",
    "5-4. Lessons shall be provided by the adviser as a principle, and the Company does not provide lessons, except when we admit separately." => "5-4. Lessons shall be provided by the adviser as a principle, and the Company does not provide lessons, except when we admit separately.",
    "5-5. Students shall agree in advance that the adviser may be a lesson only for voice and the adviser differences." => "5-5. Students shall agree in advance that the adviser may be a lesson only for voice and the adviser differences.",
    "5-6. The Company shall not assess and manage the information provided by the adviser and the adviser and the student." => "5-6. The Company shall not assess and manage the information provided by the adviser and the adviser and the student.",
    "5-7. Our company shall not be guaranteed to all about the truth, accuracy, certainty, reliability, beneficiality, etc. of various information posted by advisers and other advisers." => "5-7. Our company shall not be guaranteed to all about the truth, accuracy, certainty, reliability, beneficiality, etc. of various information posted by advisers and other advisers.",
    "5-8. The Company does not take any responsibility even if the advisers or omissions of the adviser or the third party suffered damage or losses." => "5-8. The Company does not take any responsibility even if the advisers or omissions of the adviser or the third party suffered damage or losses.",
    ...
    "(4) If the number of blocks from the adviser reaches a certain level, and it is difficult to continue using the service by the students and the Company judged" => "(4) If the number of blocks from the adviser reaches a certain level, and it is difficult to continue using the service by the students and the Company judged",
    ...
    "12-1. The lesson contract shall be established when the adviser sends an e-mail that the adviser will use the system on this service using the system on the service. ." => "12-1. The lesson contract shall be established when the adviser sends an e-mail that the adviser will use the system on this service using the system on the service. .",
    ...
    "13-1. Students shall purchase coins from us and pay us the service fee by using the purchased coins. Of the service fees, the lesson fee shall be paid by our company by transfer of cash to the adviser on behalf of the student." => "13-1. Students shall purchase coins from us and pay us the service fee by using the purchased coins. Of the service fees, the lesson fee shall be paid by our company by transfer of cash to the adviser on behalf of the student.",
    "13-2. An adviser shall determine the number of coins required for service fee payment." => "13-2. An adviser shall determine the number of coins required for service fee payment.",
    ...
    "1 Lesson contract after establishment is canceled with only our side or in the adviser side, and if the student claims coin return to our company based on that fact." => "1 Lesson contract after establishment is canceled with only our side or in the adviser side, and if the student claims coin return to our company based on that fact.",
    ...
    "1 If the student or adviser cancels the lesson contract after the establishment" => "1 If the student or adviser cancels the lesson contract after the establishment",
    "2 If our company determines if the adviser may violate or violate the advisers" => "2 If our company determines if the adviser may violate or violate the advisers",
    "3 Other cases where we need it" => "3 Other cases where we need it",
    "14-4. As a result of our investigation with the largest sincerity for both the students and the adviser, the Company finally judge The students and advisers shall follow this." => "14-4. As a result of our investigation with the largest sincerity for both the students and the adviser, the Company finally judge The students and advisers shall follow this.",
    ...
    "5 Other students, advisers, other third parties or our property, privacy, portrait right or act of violating the right to violate" => "5 Other students, advisers, other third parties or our property, privacy, portrait right or act of violating the right to violate",
    ...
    "12 Other students, advisers and other third parties, acts to use this service" => "12 Other students, advisers and other third parties, acts to use this service",
    ...
    "15 Other students, advisers Introduce services that may compete or conflict with this service for other third parties" => "15 Other students, advisers Introduce services that may compete or conflict with this service for other third parties",
    ...
    "⑳ A third party such as advisers and other students, an act that gives or imparts mental pain" => "⑳ A third party such as advisers and other students, an act that gives or imparts mental pain",
    "㉑ Init Secretariat and Take a Lesson Seminar without the permission of the adviser, recording, recording, recording" => "㉑ Init Secretariat and Take a Lesson Seminar without the permission of the adviser, recording, recording, recording",
    ...
    "18-1. The Company does not take any responsibility for the content of the student, the adviser and other third parties created by the e-mail or uploaded information created." => "18-1. The Company does not take any responsibility for the content of the student, the adviser and other third parties created by the e-mail or uploaded information created.",
    ...
    "19-3. Another participation in the course of this Customer, the student is another number of students, advisers and other third parties through our site or lesson. It shall not be provided to." => "19-3. Another participation in the course of this Customer, the student is another number of students, advisers and other third parties through our site or lesson. It shall not be provided to.",
    ...
    "Purpose to reserve and carry out languages ​​lessons between advisers who wish to provide language lessons in this service and students who wish to attend language lessons" => "Purpose to reserve and carry out languages ​​lessons between advisers who wish to provide language lessons in this service and students who wish to attend language lessons",
    "The purpose of creating and publishing a public profile of the adviser who wishes to provide lessons using this service, and for the students to pay the adviser through our company as a consideration for providing language lessons." => "The purpose of creating and publishing a public profile of the adviser who wishes to provide lessons using this service, and for the students to pay the adviser through our company as a consideration for providing language lessons.",
    ...
    "About tax payment of adviser fee" => "About tax payment of adviser fee",
    ...
    "About final income tax return to adviser activities in the side work" => "About final income tax return to adviser activities in the side work",
    ...
    "About declaration of consumption tax of income obtained in adviser activity" => "About declaration of consumption tax of income obtained in adviser activity",
    "Those who have been advisers for less than two years or who earned less than 10 million yen in the business two years ago are not considered to need to file a consumption tax, but please check the details of the business. Please." => "Those who have been advisers for less than two years or who earned less than 10 million yen in the business two years ago are not considered to need to file a consumption tax, but please check the details of the business. Please.",
    "National Tax Agency / Tax Answer / Consumption Tax" => "National Tax Agency / Tax Answer / Consumption Tax",
    "In-adviser Fees income and income declaration" => "In-adviser Fees income and income declaration",
    ...
    "Adviser introduction" => "Adviser introduction",
    ...
    "And is a contract on the provision and attendance of lessons concluded between the adviser and the student." => "And is a contract on the provision and attendance of lessons concluded between the adviser and the student.",
    "Lesson Fee" => "Lesson Fee",
    "And, as a compensation for the lesson contract, the number of students pay the adviser through our company." => "And, as a compensation for the lesson contract, the number of students pay the adviser through our company.",
    ...
    "After applying for a lesson contract by a student, a lesson contract application is canceled by the student before the adviser sends an e-mail of the application consent" => "After applying for a lesson contract by a student, a lesson contract application is canceled by the student before the adviser sends an e-mail of the application consent",
    ...
    "(Adviser) Sales Details" => "(Adviser) Sales Details",
    ...
    "3 days or more ago" => "3 days or more ago",
    "Login num days ago" => "Login :num days ago",
    "Login num hours ago" => "Login :num hours ago",
    "Login num minutes ago" => "Login :num minutes ago",
    "monday" => "Monday",
    "tuesday" => "Tuesday",
    "wednesday" => "Wednesday",
    "thursday" => "Thursday",
    ...
    "sunday" => "Sunday",
    "lesson name" => "Lesson name",
    "The application for attendance has arrived" => "The application for attendance has arrived",
    "Inquiry has arrived" => "Inquiry has arrived",
    "We have received your inquiry" => "We have received your inquiry",
    "Cancellation to attendance has arrived" => "Cancellation to attendance has arrived",
    "Completion of attendance has arrived" => "Completion of attendance has arrived",
    "Message attendance has arrived" => "Message attendance has arrived",
    "Attendance reminder notification" => "Attendance reminder notification",
    "Report to attendance has arrived" => "Report to attendance has arrived",
    "Attendance application result has arrived" => "Attendance application result has arrived",
    "Attendance review has arrived." => "Attendance review has arrived",
    "Transfer application has arrived" => "Transfer request has arrived",
    "The withdrawal process has been completed" => "The withdrawal process has been completed",
    "Your inquiry has been sent" => "Your inquiry has been sent",
    "Regarding whether or not the adviser can refuse the lesson contract application received from the student, whether or not the lesson contract can be canceled or the time can be changed after it is established, and how to handle the case where the lesson contract is canceled after it is established, this Cancellation Policy (Adviser) For) ”(hereinafter referred to as“ this policy ”). Unless otherwise specified in this policy, the definitions of terms in this policy shall be based on the definition of Adviser Terms (URL please) separately defined by the Company." => "Regarding whether or not the adviser can refuse the lesson contract application received from the student, whether or not the lesson contract can be canceled or the time can be changed after it is established, and how to handle the case where the lesson contract is canceled after it is established, this Cancellation Policy (Adviser) For) ”(hereinafter referred to as“ this policy ”). Unless otherwise specified in this policy, the definitions of terms in this policy shall be based on the definition of Adviser Terms (URL please) separately defined by the Company.",
    "The adviser is free to decide whether or not to reject the lesson contract application received from the mate." => "The adviser is free to decide whether or not to reject the lesson contract application received from the mate.",
    "The adviser will use the system on this service to send an e-mail to the effect that the mate accepts the lesson contract application, and after the lesson contract is concluded, the following cancellation policy will be applied, regardless of the date. The secretariat shall be required to pay a cancellation fee." => "The adviser will use the system on this service to send an e-mail to the effect that the mate accepts the lesson contract application, and after the lesson contract is concluded, the following cancellation policy will be applied, regardless of the date. The secretariat shall be required to pay a cancellation fee.",
    "skype link" => "https://support.skype.com/en/contact-us/",
    "tax link" => "https://www.nta.go.jp/english/index.htm",
];